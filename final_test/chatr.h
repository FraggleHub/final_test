...
//------------------------
class stringMasive // обрезок класса контейнера от интЁррэй дл€ стрингов
{
public:
    int m_length;
...
//-----------------------------------------
class Chat// : public Account // класс чат в ктором создаетс€ контейнер стрингов
{
public:
...
class Account // : public Chat// уже не нсаледник „ј“
{
public:
    string _name, _parole;    // им€
    short _id; // id
    Account();
